...
define(['jQuery', 'utils', 'wp/flags', 'wp/textlinks', 'wp/mediavoice'], function($, utils, flags, textlinks, mediavoice){
  ...
  return {
      ...
      topicly_carousel_tile: {
        ...
        hardcode: function(){
          ...
          if(/exxon_topicly_tile/.test(window.location.search)){
            creative = 'http://img.wpdigital.net/wp-srv/ad/public/static/22693/exxon-logo.png';
            height = '17';
    ...
    adTypes: {
      ...
      "flex": { "size": [[336,850],[300,600],[300,1050]], "keyvalues": { "ad": ["hp"] } },
      "flex_bb_hp": { "size": [[336,850],[300,600],[300,1050],[300,250]], "keyvalues": { "ad": ["hp","bb"], "pos": ["ad16"] } },
      "flex_re": { "size": [[300,600],[300,250]], "keyvalues": { "ad": ["bb","tp"] } },
      "flex_ss_bb": { "size": [[160,600],[300,250]], "keyvalues": { "ad": ["ss","bb"] } },
      "flex_ss_bb_hp": { "size": [[336,850],[160,600],[300,250],[300,600],[300,1050]], "keyvalues": { "ad": ["ss","bb","hp"], "pos": ["ad6"] } },
