  ...
  return {
    ...
    zones: {
      contentType: function(){
        var a = this.getString(utils.wp_meta_data.contentType);
        return a && commercialNode !== 'washingtonpost.com' && this.contentType[a.toLowerCase()] || '';
      },

      contentName: function(){
        return this.getString(utils.wp_meta_data.contentName);
      },

      subsection: function(){
        return this.getString(utils.wp_meta_data.subsection);
      }
    },
